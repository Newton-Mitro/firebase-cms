...
function ListEvent() {
  ...
  const [selectedView, setSelectedView] = useState<EventModel | null>(null);
  ...
  const {
    updatedEventId,
    updateEventStatus,
    loading: updateEventStatusLoading,
  ...
  useEffect(() => {
    getEvents(currentViewStartFrom, limit);
  }, [removeEventId, updatedEventId, limit, currentViewStartFrom]);

  return (
    <>
      <AppLoader
        isLoading={
          getEventsLoading || removeEventLoading || updateEventStatusLoading
        }
      />
        ...
        >
          <div className="flex-1">
            <div className="flex gap-2">
              ...
              >
                <span className="md:block hidden">Create Event</span>
                <svg
