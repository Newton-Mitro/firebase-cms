                ...
                disabled:bg-disabledColor shadow-sm focus:border-borderColor focus:ring focus:ring-accent focus:ring-opacity-50 text-gray-300"
                        ...
                        <div className="flex flex-col">
                          ...
                          <input
                            ...
                            type="number"
                            value={galleryState?.sections[index].order}
                            className="mt-1 block w-full rounded-sm py-1 border-borderColor bg-primary
                disabled:bg-disabledColor shadow-sm focus:border-borderColor focus:ring focus:ring-accent focus:ring-opacity-50 text-gray-300"
                            onChange={(event) => {
                              updateGallerySection(
                          ...
                          />
                          {galleryState.sections[index].errors?.order && (
                            <div className="text-xs text-red-400">
                              {galleryState.sections[index].errors?.order}
                            </div>
                          )}
                        ...
                        <div className="flex flex-col">
                          ...
                          <ReactQuill
                            ...
                            value={galleryState?.sections[index]?.content}
                            onChange={(value) => {
                              updateGallerySection("content", value, index);
                            }}
                          />

                          {galleryState.sections[index].errors?.content && (
                            <div className="text-xs text-red-400">
                              {galleryState.sections[index].errors?.content}
                            </div>
                          )}
